/**************************************************************************************************************
  ...
  File name: Init_Struct.c
Version: 1.0		Date: 2017-04-28		Author: Yanming Wang		ID: 1047930

Description:
The functions in this file are defined to Init and free the struct of LDWS Model.
The following function types are included:
+ Get_Fichier(): Read the config files and Init Donnees.
+ Init_Modele_Fichier(): Init Donnees.
+ Allocation_Modele_Struct(): Malloc the memory of M_3D_init, M_3D_est and M_Filter.
+ Init_Modele_3D(): In the initialization, given the value of M_3D_init->Param and M_3D_init->C_Param;
If lines not found, Init the M_I_init->X and CX based on M_3D_init.
+ Init_Modele_Output(): Init the values for L_output.
+ Init_Modele_Filter(): Init the values for M_Filter.
+ Init_Modele_Image(): Init the related parameters in M_I_init and M_I_est in each frame.
+ Free_Modele_OutPut(): Free the values for L_output.
+ Free_Modele_Struct(): Free the memory of M_3D_init, M_3D_est and M_Filter.
+ Free_Modele_Fichier(): Free the memory of Donnees.

The following static function types are included:
+ Allocation_Modele_Fichier(): Malloc the memory of Donnees.
+ Allocation_Modele_3D(): Malloc the memory of M_3D_new.
+ Allocation_Modele_Filter(): Malloc the memory of M_Filter.
+ Modele_VELAC(): Init the value of M_3D_init->Param and M_3D_init->C_Param.
+ Allocation_Modele_OutPut(): Malloc the memory of L_output.
+ Free_Modele_Filter(): Free the memory of M_Filter.
+ Free_Modele_3D(): Free the memory of M_3D.
...
int Get_Fichier(Fichier *Donnees,const char *fichier, const char *fichierCustom)
{
    ...
    if (fichier != NULL)
    {
        ...
        if(!ret)
        {
            my_printf("Can not find RUNFLAG= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find VEHICULE= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find MARQUEE= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Eu_N= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Ev_N= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Tx_N= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Ty_N= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Cx_N= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Cy_N= in fichier!\n");
            return ret;
        }
        ...
        if(Donnees->runFlag)
        {
            ...
            if(!ret)
            {
                my_printf("Can not find Eu_W= in fichier!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find Ev_W= in fichier!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find Tx_W= in fichier!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find Ty_W= in fichier!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find Cx_W= in fichier!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find Cy_W= in fichier!\n");
                return ret;
            }
        }
        else
        ...
        if(!ret)
        {
            my_printf("Can not find Z0= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Largeur= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find X0= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Alpha= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Psi= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Ch= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Cl= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Dev_Largeur= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Dev_X0= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Dev_Alpha= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Dev_Psi= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Dev_Ch= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Dev_Cl= in fichier!\n");
            return ret;
        }
        ...
        if(Donnees->runFlag)
        {
            ...
            if(!ret)
            {
                my_printf("Can not find V_haut_W= in fichier!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find V_bas_W= in fichier!\n");
                return ret;
            }
        }
        else
        {
            ...
            if(!ret)
            {
                my_printf("Can not find V_haut_N= in fichier!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find V_bas_N= in fichier!\n");
                return ret;
            }
        }
        ...
        if(!ret)
        {
            my_printf("Can not find H_zone= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Var_Max= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Var_Min= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Largeur_Zone_Min= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Largeur_Zone_Max= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Marge_Image= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Nb_Pts_Min= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Seuil_Grad= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Grad_Core_Length= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find L_Bande_Sup= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find L_Bande_Inf= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Nb_Tir_Med= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Confiance= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Ecart_Type= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Residu_Max= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Coef_Median= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Conf_Pts= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Erreur_mini= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Nb_Iterations= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Proba= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Proba_Bord= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Tolerance= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Lambda_Y= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Delta_L= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Delta_X0= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Delta_Alpha= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Delta_Psi= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Delta_Ch= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Delta_Cl= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Confidence= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find ValidWidth= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Filter_cp= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Debug= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Aff_Zone= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Aff_Median= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Aff_Result= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find Custom_init= in fichier!\n");
            return ret;
        }
        ...
        if(!ret)
        {
            my_printf("Can not find init_center= in fichier!\n");
            return ret;
        }
        ...
        if(customInit)
        {
            ...
            if(!ret)
            {
                my_printf("Can not find CarWidth= in fichierCustom!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find LeftDeviation= in fichierCustom!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find RightDeviation= in fichierCustom!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find CameraHigh= in fichierCustom!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find RoadWidth= in fichierCustom!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find VehicleWarning= in fichierCustom!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find CameraPosx= in fichierCustom!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find FirstLineY= in fichierCustom!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find SecondLineY= in fichierCustom!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find VerticalLineX= in fichierCustom!\n");
                return ret;
            }
            ...
            if(!ret)
            {
                my_printf("Can not find HorizontalLineY= in fichierCustom!\n");
                return ret;
            }
            ...
            else
            {
                ...
                my_printf("-----------hor:%d",horizontalLineY);
            }
            ...
            if(!ret)
            {
                my_printf("Can not find FCWSD_th= in fichierCustom!\n");
                return ret;
            }
...
static void Allocation_Modele_Fichier(Fichier *Donnees)
{
    ...
    Donnees->Compt_indice		= (int *)my_malloc(LDWS_NB_ZONES * sizeof(int));
    memset(Donnees->Compt_indice, 0, LDWS_NB_ZONES * sizeof(int));
    Donnees->templet			= (Templet *) my_malloc(LDWS_NB_ZONES * sizeof(Templet));
    memset(Donnees->templet, 0, LDWS_NB_ZONES * sizeof(Templet));

    Donnees->fInterFrameDisp	= (double *)my_malloc(LDWS_NB_ZONES * sizeof(double));
    memset(Donnees->fInterFrameDisp, 0, LDWS_NB_ZONES * sizeof(double));


    Donnees->Tab_Var		= (double *)my_malloc(LDWS_NB_ZONES * sizeof(double));	/* Variance 																			 */
    memset(Donnees->Tab_Var, 0, LDWS_NB_ZONES * sizeof(double));

    Donnees->Tab_Bool		= (int *)my_malloc(LDWS_NB_ZONES * sizeof(int));	/* Used to mark  the classified  area */
    memset(Donnees->Tab_Bool, 0, LDWS_NB_ZONES * sizeof(int));

    Donnees->tab_residus	= (double *)my_malloc(sizeof(double)* Donnees->Cx);
    memset(Donnees->tab_residus, 0, sizeof(double)* Donnees->Cx);


    Donnees->dataAve	= (Data_Stat *) my_malloc(LDWS_NB_BANDES * sizeof(Data_Stat));
    memset(Donnees->dataAve, 0, LDWS_NB_BANDES * sizeof(Data_Stat));

    Donnees->dataDiff	= (Data_Stat *) my_malloc(LDWS_NB_ZONES * sizeof(Data_Stat));
    memset(Donnees->dataDiff, 0, LDWS_NB_ZONES * sizeof(Data_Stat));

    Donnees->pCBPoint	= (Point *) my_malloc((CLIP_BSPLINE_POINT_NUM + 1) * sizeof(Point));
    memset(Donnees->pCBPoint, 0, (CLIP_BSPLINE_POINT_NUM + 1) * sizeof(Point));


    Donnees->M_A_J_Zone_X	= (double *)my_malloc(LDWS_NB_ZONES * sizeof(double));
    memset(Donnees->M_A_J_Zone_X, 0, LDWS_NB_ZONES * sizeof(double));

    Donnees->M_A_J_Zone_CX	= (double *)my_malloc(LDWS_NB_ZONES * LDWS_NB_ZONES * sizeof(double));
    memset(Donnees->M_A_J_Zone_CX, 0, LDWS_NB_ZONES * LDWS_NB_ZONES * sizeof(double));


    Donnees->M_A_J_Param_X		= (double *)my_malloc(Donnees->NB_Z_P * sizeof(double));
    memset(Donnees->M_A_J_Param_X, 0, Donnees->NB_Z_P * sizeof(double));

    Donnees->M_A_J_Param_CX		= (double *)my_malloc(Donnees->NB_Z_P * Donnees->NB_Z_P * sizeof(double));
    memset(Donnees->M_A_J_Param_CX, 0, Donnees->NB_Z_P * Donnees->NB_Z_P * sizeof(double));


    Donnees->M_A_J_Param_X_new	= (double *)my_malloc(Donnees->NB_Z_P * sizeof(double));
    memset(Donnees->M_A_J_Param_X_new, 0, Donnees->NB_Z_P * sizeof(double));

    Donnees->M_A_J_Param_CX_new = (double *)my_malloc(Donnees->NB_Z_P * Donnees->NB_Z_P * sizeof(double));
    memset(Donnees->M_A_J_Param_CX_new, 0, Donnees->NB_Z_P * Donnees->NB_Z_P * sizeof(double));


    Donnees->M_A_J_Suivi3_X_new		= (double *)my_malloc(LDWS_NB_PARAM * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_X_new, 0, LDWS_NB_PARAM * sizeof(double));

    Donnees->M_A_J_Suivi3_CX_new	= (double *)my_malloc(LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_CX_new, 0, LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));

    Donnees->M_A_J_Suivi3_CX_temp	= (double *)my_malloc(LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_CX_temp, 0, LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));

    Donnees->M_A_J_Suivi3_M_Suivi	= (double *)my_malloc(LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_M_Suivi, 0, LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));


    Donnees->M_A_J_Suivi3_M			= (double *)my_malloc(LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_M, 0, LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));

    Donnees->M_A_J_Suivi3_M_T		= (double *)my_malloc(LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_M_T, 0, LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));

    Donnees->M_A_J_Suivi3_H			= (double *)my_malloc(LDWS_NB_PARAM * Donnees->NB_Z_P * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_H, 0, LDWS_NB_PARAM * Donnees->NB_Z_P * sizeof(double));

    Donnees->M_A_J_Suivi3_H_T		= (double *)my_malloc(LDWS_NB_PARAM * Donnees->NB_Z_P * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_H_T, 0, LDWS_NB_PARAM * Donnees->NB_Z_P * sizeof(double));

    Donnees->M_A_J_Suivi3_K_inv		= (double *)my_malloc(LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_K_inv, 0, LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));

    Donnees->M_A_J_Suivi3_K			= (double *)my_malloc(LDWS_NB_PARAM * Donnees->NB_Z_P * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_K, 0, LDWS_NB_PARAM * Donnees->NB_Z_P * sizeof(double));

    Donnees->M_A_J_Suivi3_X_temp	= (double *)my_malloc(LDWS_NB_PARAM * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_X_temp, 0, LDWS_NB_PARAM * sizeof(double));

    Donnees->M_A_J_Suivi3_X_temp2	= (double *)my_malloc(LDWS_NB_PARAM * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_X_temp2, 0, LDWS_NB_PARAM * sizeof(double));

    Donnees->M_A_J_Suivi3_X			= (double *)my_malloc(Donnees->NB_Z_P * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_X, 0, Donnees->NB_Z_P * sizeof(double));

    Donnees->M_A_J_Suivi3_CX		= (double *)my_malloc(Donnees->NB_Z_P * Donnees->NB_Z_P * sizeof(double));
    memset(Donnees->M_A_J_Suivi3_CX, 0, Donnees->NB_Z_P * Donnees->NB_Z_P * sizeof(double));

    Donnees->M_A_J_Suivi3_Temp		= (double *)my_malloc(LDWS_NB_PARAM * Donnees->NB_Z_P * sizeof(double));
...
{
    my_free(Donnees->Compt_indice);
    Donnees->Compt_indice = NULL;

    my_free(Donnees->templet);
    Donnees->templet = NULL;

    my_free(Donnees->fInterFrameDisp);
    Donnees->fInterFrameDisp = NULL;

    my_free(Donnees->Tab_Var);
    Donnees->Tab_Var = NULL;

    my_free(Donnees->Tab_Bool);
    Donnees->Tab_Bool = NULL;

    my_free(Donnees->tab_residus);
    Donnees->tab_residus = NULL;

    my_free(Donnees->dataAve);
    Donnees->dataAve = NULL;

    my_free(Donnees->dataDiff);
    Donnees->dataDiff = NULL;

    my_free(Donnees->pCBPoint);
    Donnees->pCBPoint = NULL;

    my_free(Donnees->M_A_J_Zone_X);
    Donnees->M_A_J_Zone_X = NULL;

    my_free(Donnees->M_A_J_Zone_CX);
    Donnees->M_A_J_Zone_CX = NULL;


    my_free(Donnees->M_A_J_Param_X);
    Donnees->M_A_J_Param_X = NULL;

    my_free(Donnees->M_A_J_Param_CX);
    Donnees->M_A_J_Param_CX = NULL;

    my_free(Donnees->M_A_J_Param_X_new);
    Donnees->M_A_J_Param_X_new = NULL;

    my_free(Donnees->M_A_J_Param_CX_new);
    Donnees->M_A_J_Param_CX_new = NULL;


    my_free(Donnees->M_A_J_Suivi3_X_new);
    Donnees->M_A_J_Suivi3_X_new = NULL;

    my_free(Donnees->M_A_J_Suivi3_CX_new);
    Donnees->M_A_J_Suivi3_CX_new = NULL;

    my_free(Donnees->M_A_J_Suivi3_CX_temp);
    Donnees->M_A_J_Suivi3_CX_temp = NULL;

    my_free(Donnees->M_A_J_Suivi3_M_Suivi);
    Donnees->M_A_J_Suivi3_M_Suivi = NULL;

    my_free(Donnees->M_A_J_Suivi3_M);
    Donnees->M_A_J_Suivi3_M = NULL;

    my_free(Donnees->M_A_J_Suivi3_M_T);
    Donnees->M_A_J_Suivi3_M_T = NULL;

    my_free(Donnees->M_A_J_Suivi3_H);
    Donnees->M_A_J_Suivi3_H = NULL;

    my_free(Donnees->M_A_J_Suivi3_H_T);
    Donnees->M_A_J_Suivi3_H_T = NULL;

    my_free(Donnees->M_A_J_Suivi3_K_inv);
    Donnees->M_A_J_Suivi3_K_inv = NULL;

    my_free(Donnees->M_A_J_Suivi3_K);
    Donnees->M_A_J_Suivi3_K = NULL;

    my_free(Donnees->M_A_J_Suivi3_X_temp);
    Donnees->M_A_J_Suivi3_X_temp = NULL;

    my_free(Donnees->M_A_J_Suivi3_X_temp2);
    Donnees->M_A_J_Suivi3_X_temp2 = NULL;

    my_free(Donnees->M_A_J_Suivi3_X);
    Donnees->M_A_J_Suivi3_X = NULL;

    my_free(Donnees->M_A_J_Suivi3_CX);
    Donnees->M_A_J_Suivi3_CX = NULL;

    my_free(Donnees->M_A_J_Suivi3_Temp);
    Donnees->M_A_J_Suivi3_Temp = NULL;

	my_free(Donnees->edgeValue);
	Donnees->edgeValue = NULL;

	my_free(Donnees->edgeValueV);
...
static void Allocation_Modele_3D(Modele_3D * M_3D_new, const Fichier *Donnees)
{
    M_3D_new->V			= (int *)my_malloc(LDWS_NB_ZONES * sizeof(int));	/* Xd */
    memset(M_3D_new->V, 0, LDWS_NB_ZONES * sizeof(int));

    M_3D_new->X			= (double *)my_malloc(Donnees->NB_Z_P * sizeof(double));	/* X */
    memset(M_3D_new->X, 0, Donnees->NB_Z_P * sizeof(double));

    M_3D_new->CX		= (double *)my_malloc(Donnees->NB_Z_P * Donnees->NB_Z_P * sizeof(double));	/* Cx */
    memset(M_3D_new->CX, 0, Donnees->NB_Z_P * Donnees->NB_Z_P * sizeof(double));

    M_3D_new->Param		= (double *)my_malloc(LDWS_NB_PARAM * sizeof(double));	/* Xl */
    memset(M_3D_new->Param, 0, LDWS_NB_PARAM * sizeof(double));

    M_3D_new->C_Param	= (double *)my_malloc(LDWS_NB_PARAM * LDWS_NB_PARAM * sizeof(double));	/* Cxl */
...
static void Allocation_Modele_Filter(Modele_Filter *M_Filter, const Fichier *Donnees)
{
    M_Filter->dataSrc		= (Data_Stat *) my_malloc(LDWS_NB_ZONES * sizeof(Data_Stat));
    memset(M_Filter->dataSrc, 0, LDWS_NB_ZONES * sizeof(Data_Stat));

    M_Filter->dataAve		= (Data_Stat *) my_malloc(LDWS_NB_BANDES * sizeof(Data_Stat));
    memset(M_Filter->dataAve, 0, LDWS_NB_BANDES * sizeof(Data_Stat));

    M_Filter->dataAveDiff	= (Data_Stat *) my_malloc(LDWS_NB_BANDES * sizeof(Data_Stat));
    memset(M_Filter->dataAveDiff, 0, LDWS_NB_BANDES * sizeof(Data_Stat));

    M_Filter->templet		= (Templet *) my_malloc(LDWS_NB_ZONES * sizeof(Templet));
...
{
    /* desallocation des structures du modele image */
    my_free(M_Filter->dataSrc);
    M_Filter->dataSrc = NULL;

    my_free(M_Filter->dataAve);
    M_Filter->dataAve = NULL;

    my_free(M_Filter->dataAveDiff);
    M_Filter->dataAveDiff = NULL;

    my_free(M_Filter->templet);
...
static void Allocation_Modele_OutPut(LDWS_Output *L_output, const Fichier *Donnees)
{
    L_output->pPoint	= (LDWS_Point *) my_malloc(L_output->LPointLength * LDWS_NB_BANDES * sizeof(LDWS_Point));
    memset(L_output->pPoint, 0, L_output->LPointLength * LDWS_NB_BANDES * sizeof(LDWS_Point));

    L_output->pCaPoint	= (LDWS_Point *) my_malloc(L_output->NB_INTERVALLES * LDWS_NB_BANDES * sizeof(LDWS_Point));
    memset(L_output->pCaPoint, 0, L_output->NB_INTERVALLES * LDWS_NB_BANDES * sizeof(LDWS_Point));

    L_output->Param		= (double *)my_malloc(LDWS_NB_PARAM * sizeof(double));
...
{
    /* desallocation des structures du modele image */
    my_free(L_output->pPoint);
    L_output->pPoint = NULL;

    my_free(L_output->pCaPoint);
    L_output->pCaPoint = NULL;

    my_free(L_output->Param);
    L_output->Param = NULL;
