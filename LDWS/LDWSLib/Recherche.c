...
Description:
	...
	+ CopieEtat(): Copy M_I_init to M_I_new.
	+ Proba_Restante(): Decide if zone of M_I_new has enough residual probabilities.
	+ Remplir_Zone(): Fill the detect zone.
	+ Critere(): Calculate the Proba of lines based on the detected points
