...
File name: Road_Tracker.c
Version: 1.0		Date: 2017-04-28		Author: Yanming Wang		ID: 1047930

Description:
	The functions in this file are defined to realize the main process of LDWS.
	The following function types are included:
	+ LDWS_InitRoadTracker(): Init the values of parameters.
	+ LDWS_RoadTracker(): The main realization of LDWS.
