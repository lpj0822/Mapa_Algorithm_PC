...
[in]	pOriGrayImg		WissenImage*	 sizeof(WissenImage*)  Gray image buff to be detected.
[in]	pLDWSOutput	    void*		 sizeof(void*)        The result of LDWS (Lane Departure Warning System).
[in]	p3DMapOutput    void*	     sizeof(void*) 	      The result of 3D obstacle detection.
[in]	roi             WissenRect*	 sizeof(WissenRect*)   The ROI region of image to be detected.
...
*/
extern int  FCWSD_Processor(const int index, const WissenImage *pOriGrayImg, const void *pLDWSOutput, const void *p3DMapOutput,
...
[in]	pGrayImg		WissenImage*	 sizeof(WissenImage*)  Gray image buff to be detected.
[in]	roi             WissenRect*	 sizeof(WissenRect*)   The ROI region of image to be detected.
[in]	minObjectSize   WissenSize*	 sizeof(WissenSize*)   The minimum size of vehicle can be detected.
[in]	maxObjectSize   WissenSize*	 sizeof(WissenSize*)   The maximum size of vehicle can be detected.
[in]	groupThreshold	int		     4-Byte	              The threshold of group rect.
...
*/
extern int  FCWSD_Processor_ROI(const int index, const int VerFlg, const WissenImage *pGrayImg, WissenRect *roi, \
...
extern void detcorByRec(const WissenImage GrayImg, const unsigned char dayOrNight);
